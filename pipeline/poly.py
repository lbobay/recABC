...
try:
	os.mkdir("" + SP + "/merged/metrics")
except OSError:
	pass
	
try:
	os.mkdir("" + SP + "/merged/distances")
except OSError:
	pass
...
for file in simulations:
	...
	if file.startswith("data"):
		...
		h=open("" + SP + "/merged/metrics/" + file.split(".fa")[0] + ".txt","w")
		...
		g=open("" + SP + "/merged/distances/" + file.split(".fa")[0] + ".txt","w")
		average=[]
		pie={}
		for id1 in seq:
			#print id1
		...
		h=open("" + SP + "/merged/metrics/" + file.split(".fa")[0] + ".txt","a")
